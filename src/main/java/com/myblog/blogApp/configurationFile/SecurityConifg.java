package com.myblog.blogApp.configurationFile;
...
//        UserDetails userDetails = User.builder().username("Gaurav").password( passwordEncoder().encode("Happy#123")).roles("USER").build();
